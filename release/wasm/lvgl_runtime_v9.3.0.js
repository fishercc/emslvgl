...
var ASM_CONSTS = {
  1050464: ($0) => { startToDebuggerMessage($0); },  
 1050496: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1050571: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1050646: ($0) => { finishToDebuggerMessage($0); },  
 1050679: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1050709: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1050739: ($0) => { lvglScreenTick($0); },  
 1050763: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1050803: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1050857: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1050911: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1050964: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1051017: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1051070: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1051103: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1051139: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1051184: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1051290: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1051326: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1051363: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1051403: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1051460: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1051519: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
