...
var ASM_CONSTS = {
  1054192: ($0) => { startToDebuggerMessage($0); },  
 1054224: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1054299: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1054374: ($0) => { finishToDebuggerMessage($0); },  
 1054407: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1054437: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1054467: ($0) => { lvglScreenTick($0); },  
 1054491: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1054531: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1054585: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1054639: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1054692: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1054745: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1054798: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1054831: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1054867: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1054912: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1055018: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1055054: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1055091: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1055131: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1055188: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1055247: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
