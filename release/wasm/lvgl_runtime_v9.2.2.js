...
var ASM_CONSTS = {
  1032336: ($0) => { startToDebuggerMessage($0); },  
 1032368: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1032443: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1032518: ($0) => { finishToDebuggerMessage($0); },  
 1032551: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1032581: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1032611: ($0) => { lvglScreenTick($0); },  
 1032635: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1032675: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1032729: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1032783: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1032836: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1032889: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1032942: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1032975: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1033011: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1033056: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1033162: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1033198: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1033235: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1033275: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1033332: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1033391: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
