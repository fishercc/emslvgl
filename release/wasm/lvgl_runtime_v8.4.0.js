...
var ASM_CONSTS = {
  1039536: ($0) => { startToDebuggerMessage($0); },  
 1039568: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1039643: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1039718: ($0) => { finishToDebuggerMessage($0); },  
 1039751: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1039781: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1039811: ($0) => { lvglScreenTick($0); },  
 1039835: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1039875: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1039929: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1039983: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1040036: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1040089: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1040142: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1040175: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1040211: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1040256: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1040362: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1040398: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1040435: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1040475: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1040532: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1040591: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
