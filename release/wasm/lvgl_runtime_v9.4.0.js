...
var ASM_CONSTS = {
  1058896: ($0) => { startToDebuggerMessage($0); },  
 1058928: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1059003: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1059078: ($0) => { finishToDebuggerMessage($0); },  
 1059111: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1059141: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1059171: ($0) => { lvglScreenTick($0); },  
 1059195: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1059235: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1059289: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1059343: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1059396: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1059449: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1059502: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1059535: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1059571: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1059616: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1059722: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1059758: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1059795: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1059835: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1059892: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1059951: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
