...
var ASM_CONSTS = {
  1055184: ($0) => { startToDebuggerMessage($0); },  
 1055216: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1055291: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1055366: ($0) => { finishToDebuggerMessage($0); },  
 1055399: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1055429: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1055459: ($0) => { lvglScreenTick($0); },  
 1055483: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1055523: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1055577: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1055631: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1055684: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1055737: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1055790: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1055823: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1055859: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1055904: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1056010: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1056046: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1056083: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1056123: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1056180: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1056239: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
