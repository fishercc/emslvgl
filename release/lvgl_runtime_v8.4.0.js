...
var ASM_CONSTS = {
  1036112: ($0) => { startToDebuggerMessage($0); },  
 1036144: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1036219: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1036294: ($0) => { finishToDebuggerMessage($0); },  
 1036327: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1036357: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1036387: ($0) => { lvglScreenTick($0); },  
 1036411: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1036451: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1036505: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1036559: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1036612: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1036665: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1036718: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1036751: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1036787: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1036832: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1036938: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1036974: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1037011: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1037051: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1037108: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1037167: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
